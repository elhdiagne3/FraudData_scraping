...
selected_page = st.sidebar.radio(
    ...
    format_func=lambda page: f"{page} { '🏠' if page == 'Home' else '' if page == 'Facebook' else ''} ",
)

# Call the selected page function
page = page_names_to_funcs[selected_page]()
...
def main():
    ...
    # Sidebar navigation
    page = st.sidebar.radio("Navigation", page)

    # Render different pages based on navigation
    if page in ("Home", "Facebook") :
        page
